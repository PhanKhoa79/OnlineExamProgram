...
import { downloadQuestionTemplateFile } from '@/features/question/services/questionService';

export type FileType = 'xlsx' | 'csv';

export const QuestionImportFileModal = ({
  open,
  setOpen,
  fileType,
  handleImport,
  ...
  const handleDownloadTemplate = async (e?: React.MouseEvent) => {
    ...
    try {
      await downloadQuestionTemplateFile(fileType);
      toast({
  ...
  return (
    <CustomModal
      open={open}
      setOpen={setOpen}
      title={`Nhập câu hỏi từ file ${fileType === 'xlsx' ? 'Excel' : 'CSV'}`}
      ...
      <div className="space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                Tải xuống file mẫu để biết đúng định dạng dữ liệu câu hỏi cần import
              </p>
            </div>
            <button
              type="button"
        ...
        <div className="space-y-4">
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
            Chọn file {fileType?.toUpperCase()} để nhập câu hỏi
          </label>
          ...
          <div className="flex gap-3">
            ...
            <div className="text-sm text-amber-800 dark:text-amber-200">
              ...
              <ul className="mt-2 space-y-1 list-disc list-inside text-xs">
                <li>Đảm bảo file tuân thủ đúng định dạng mẫu câu hỏi</li>
                <li>Nội dung câu hỏi phải có ý nghĩa và rõ ràng</li>
                <li>Độ khó phải là một trong các giá trị: dễ, trung bình, khó</li>
                <li>Môn học phải tồn tại trong hệ thống</li>
