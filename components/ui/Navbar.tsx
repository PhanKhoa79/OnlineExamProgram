    ...
    <nav className="bg-white py-4 px-6 shadow-sm">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="/" className="text-[#5D5A88] hover:text-[#4A3AFF] transition-colors font-dm-sans">
            Home
          </Link>
        ...
        <div className="hidden md:flex items-center gap-4">
          <Link
            href="/login"
            className="px-6 py-2 text-[#4A3AFF] border border-[#4A3AFF] rounded-lg hover:bg-[#4A3AFF] hover:text-white transition-colors font-dm-sans"
          >
            Login
          </Link>
          <Link
