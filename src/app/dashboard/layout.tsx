...
const CommandPaletteWrapper = dynamic(() => import('@/components/dashboard/CommandPaletteWrapper').then(mod => ({ default: mod.CommandPaletteWrapper })), {
  loading: () => null
});
...
const QuickActionsSidebar = dynamic(() => import('@/components/dashboard/QuickActionsSidebar').then(mod => ({ default: mod.QuickActionsSidebar })), {
...
const ColorThemeProvider = dynamic(() => import('@/components/providers/ColorThemeProvider').then(mod => ({ default: mod.ColorThemeProvider })));

const DashboardTemplateProvider = dynamic(() => import('@/components/providers/DashboardTemplateProvider').then(mod => ({ default: mod.DashboardTemplateProvider })));

const TemplateWrapper = dynamic(() => import('@/components/dashboard/TemplateWrapper').then(mod => ({ default: mod.TemplateWrapper })));
            ...
            <TemplateWrapper>
              ...
              <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-slate-900 dark:to-indigo-950 p-2 md:p-4">
                ...
                <div className="relative z-10 flex gap-4 h-screen">
                  ...
                  <Suspense fallback={<div className="w-64 bg-gray-100 dark:bg-gray-800 animate-pulse rounded-2xl" />}>
                    <QuickActionsSidebar />
                  </Suspense>
